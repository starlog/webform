...
export const controlThemeMap: Record<string, ThemeColorResolver> = {
  Button: (t) => ({
    background: t.controls.button.background,
    foreground: t.controls.button.foreground,
  }),
  TextBox: (t) => ({
    background: t.controls.textInput.background,
    foreground: t.controls.textInput.foreground,
  }),
  NumericUpDown: (t) => ({
    background: t.controls.textInput.background,
    foreground: t.controls.textInput.foreground,
  ...
  ComboBox: (t) => ({
    ...
    foreground: t.controls.select.foreground,
  }),
  ListBox: (t) => ({
    background: t.controls.select.background,
    foreground: t.controls.select.foreground,
  ...
  GroupBox: (t) => ({
    background: t.controls.panel.background,
    foreground: t.controls.groupBox.foreground,
  }),
  DataGridView: (t) => ({
    background: t.controls.dataGrid.rowBackground,
    foreground: t.controls.dataGrid.rowForeground,
  }),
  MenuStrip: (t) => ({
    background: t.controls.menuStrip.background,
    foreground: t.controls.menuStrip.foreground,
  }),
  ToolStrip: (t) => ({
    background: t.controls.toolStrip.background,
    foreground: t.controls.toolStrip.foreground,
  }),
  BindingNavigator: (t) => ({
    background: t.controls.toolStrip.background,
    foreground: t.controls.toolStrip.foreground,
  ...
  StatusStrip: (t) => ({
    background: t.controls.statusStrip.background,
    foreground: t.controls.statusStrip.foreground,
  }),
  TabControl: (t) => ({
    background: t.controls.tabControl.contentBackground,
    foreground: t.controls.tabControl.tabActiveForeground,
  }),
  ProgressBar: (t) => ({
    background: t.controls.progressBar.background,
    foreground: t.form.foreground,
  }),
...
/** 폼의 "크롬" 컨트롤은 항상 테마 색상을 따름 (themeColorMode 무관) */
export const chromeControlTypes = new Set<string>([
  'MenuStrip',
  'ToolStrip',
  'BindingNavigator',
  'StatusStrip',
...
export interface ResolvedControlColors {
  background: string;
  color: string;
}

export function resolveControlThemeColors(
  controlType: string,
  theme: ThemeTokens,
...
export function computeControlColors(
  controlType: string,
  theme: ThemeTokens,
  themeColorMode: 'theme' | 'control',
  props: { backColor?: string; foreColor?: string },
): ResolvedControlColors {
  const themeColors = resolveControlThemeColors(controlType, theme);

  if (themeColorMode === 'theme' || chromeControlTypes.has(controlType)) {
    return { background: themeColors.background, color: themeColors.foreground };
  }
