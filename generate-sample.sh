      ...
      "eventHandlers": [
        {
          ...
          "eventName": "Click",
          "handlerType": "server",
          "handlerCode": "var types = ['Column', 'Bar', 'Line', 'Area', 'Pie', 'Doughnut', 'Scatter', 'Radar'];\nvar idx = ctx.controls.cboChartType.selectedIndex;\nif (idx >= 0 && idx < types.length) {\n  var t = types[idx];\n  ctx.controls.chartMain.chartType = t;\n  ctx.controls.chartMain.title = t + ' 차트 데모';\n  if (t === 'Scatter') {\n    ctx.controls.chartMain.series = [{x:10,y:30},{x:20,y:50},{x:35,y:45},{x:50,y:80},{x:65,y:60},{x:80,y:70}];\n  } else if (t === 'Pie' || t === 'Doughnut') {\n    ctx.controls.chartMain.series = [{name:'기타',value:45},{name:'식품',value:18},{name:'의류',value:25},{name:'전자제품',value:12}];\n  } else if (t === 'Radar') {\n    ctx.controls.chartMain.series = [{x:'기획',A:80,B:65},{x:'개발',A:90,B:70},{x:'디자인',A:60,B:85},{x:'마케팅',A:75,B:80},{x:'QA',A:85,B:60},{x:'고객지원',A:70,B:90}];\n  } else {\n    ctx.controls.chartMain.series = [{name:'1월','매출':1200,'비용':800},{name:'2월','매출':1500,'비용':900},{name:'3월','매출':1800,'비용':1100},{name:'4월','매출':1400,'비용':850},{name:'5월','매출':2100,'비용':1300},{name:'6월','매출':1900,'비용':1200}];\n  }\n}"
        },
        {
          "controlId": "btnLoadData",
          "eventName": "Click",
          "handlerType": "server",
          "handlerCode": "var t = ctx.controls.chartMain.chartType;\nif (t === 'Scatter') {\n  ctx.controls.chartMain.series = [{x:15,y:25},{x:25,y:55},{x:40,y:40},{x:55,y:85},{x:70,y:65},{x:85,y:75},{x:30,y:60}];\n} else if (t === 'Pie' || t === 'Doughnut') {\n  ctx.controls.chartMain.series = [{name:'서울',value:40},{name:'부산',value:25},{name:'대구',value:20},{name:'기타',value:15}];\n} else if (t === 'Radar') {\n  ctx.controls.chartMain.series = [{x:'공격',team1:80,team2:65},{x:'방어',team1:70,team2:85},{x:'속도',team1:90,team2:60},{x:'기술',team1:85,team2:75},{x:'체력',team1:75,team2:90}];\n} else {\n  ctx.controls.chartMain.series = [{name:'1월','매출':980,'비용':720},{name:'2월','매출':1350,'비용':880},{name:'3월','매출':2200,'비용':1400},{name:'4월','매출':1750,'비용':1050},{name:'5월','매출':2600,'비용':1550},{name:'6월','매출':2100,'비용':1250},{name:'7월','매출':2800,'비용':1700}];\n}\nctx.controls.chartMain.title = ctx.controls.chartMain.chartType + ' 차트 데모 (업데이트)';"
        },
        {
